        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DentistProfiles_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Appointments_DentalServices_ServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    DentistProfileId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DentistAvailabilities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DentistAvailabilities_AspNetUsers_DentistId",
                        column: x => x.DentistId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DentistAvailabilities_DentistProfiles_DentistProfileId",
                        column: x => x.DentistProfileId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DentistAvailabilities_DentistId_DayOfWeek",
                table: "DentistAvailabilities",
                columns: new[] { "DentistId", "DayOfWeek" });

            migrationBuilder.CreateIndex(
                name: "IX_DentistAvailabilities_DentistProfileId",
                table: "DentistAvailabilities",
                column: "DentistProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_DentistProfiles_UserId",
